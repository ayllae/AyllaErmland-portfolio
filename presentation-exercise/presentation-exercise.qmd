...
state_table <- state_data %>%
  ...
  # Footer
  tab_source_note(
    source_note = "Source: [Forbes Advisor 2023 Pet Insurance Survey](https://www.forbes.com/advisor/insurance/pet-insurance-pet-peeves-by-state/)"
  )
