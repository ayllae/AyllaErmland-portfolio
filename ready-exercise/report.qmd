...
#| echo: FALSE
knitr::include_graphics(here("ready-exercise", "height_by_exercise_type.png"))
```
...
#| echo: FALSE
knitr::include_graphics(here("ready-exercise", "weight_vs_bodyfatpercentage.png"))
```
...
```{r}
table_file3 = here("ready-exercise", "resulttable3.rds")
